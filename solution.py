...
def printStarHub(n):
    ...
    """
    # Check for range - 1 to 100 only and is an integer
    if n < 1 or n > 100 or type(n).__name__ != 'int':
        # if n exceeds range, ask for another input
        print('Please input a number from 1 to 100 inclusive')
        return None
